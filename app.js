function main() {
  ...
  const voto6 = document.getElementById('voto6') // vale 100%
  ...
  submitButton.addEventListener('click', (event) => {
    ...
    const media = (parseInt(voto1.value) * 10 + parseInt(voto2.value) * 3.333 + parseInt(voto3.value) * 3.333 + parseInt(voto4.value) * 3.333 + parseInt(voto5.value) * 10 + parseInt(voto6.value) * 10 + parseInt(voto7.value) * 20) / 59.999
